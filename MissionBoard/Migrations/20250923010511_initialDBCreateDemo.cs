...
{
    /// <inheritdoc />
    public partial class initialDBCreateDemo : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRights", x => new { x.RightsId, x.UsersId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_UserRights_Users_UsersId",
                        column: x => x.UsersId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
